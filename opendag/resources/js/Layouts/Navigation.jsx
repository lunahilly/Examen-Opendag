    ...
    return isSmaller ? (
                        ...
                        <nav className="header__sidebar">
                            ...
                            <ul className="header__sidebar--list">
                                ...
                                }
                                {
                                    settings.contact ?
                                        <li className="header__sidebar--item">
                                            <a href={route('contact.index')} className={`header__sidebar--item-link ${url == '/contact' ? 'header__navigation--link-active' : null} `}>Beacon</a>
                                        </li>
                                        : null
                                }
                                {
                                    user != null ?
                                        <li className="header__sidebar--item">
                                            <a href={route('contact.add')} className={`header__sidebar--item-link ${url == '/beacons' ? 'header__navigation--link-active' : null} `}>Beacons management</a>
                                        </li>
                                        : null
                                }
                                {
        ...
        <header className="header">
            ...
            <nav className="header__navigation">
                ...
                {
                    settings.contact ?
                        <a href={route('contact.index')} className={`header__navigation--link ${url == '/contact' ? 'header__navigation--link-active' : null} `}>Beacon</a>
                        : null
                }
                {
                    user != null ?
                        <a href={route('contact.add')} className={`header__navigation--link ${url == '/beacons' ? 'header__navigation--link-active' : null} `}>Beacons management</a>
                        : null
                }
                {
                    user != null ?
